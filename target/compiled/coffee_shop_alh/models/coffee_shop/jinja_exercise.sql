...
sum(case when product_category = 'coffee beans' then price end) as coffee beans_amount,

sum(case when product_category = 'merch' then price end) as merch_amount,

sum(case when product_category = 'brewing supplies' then price end) as brewing supplies_amount,
